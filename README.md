...
- Motor de juego 2.5D desarrollado completamente en **C++**
- Implementación de **sockets** para multijugador en red
...
- Colección de trabajos prácticos con **datasets reales**
- Ejercicios de **Pandas** (limpieza, transformación, EDA)
